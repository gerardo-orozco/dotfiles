...
defaults write NSGlobalDomain AppleHighlightColor -string "0.592156 0.819607 1"
...
# Disabling for personal macbook as this might reduce the battery life? verify this
# sudo systemsetup -setcomputersleep Off > /dev/null

# Check for software updates daily, not just once per week
# Me: One week is good for me
# defaults write com.apple.SoftwareUpdate ScheduleFrequency -int 1

# Disable Notification Center and remove the menu bar icon
# Me: I want Notification Center enabled
...
TERM_PROFILE='Monokai';
CURRENT_PROFILE="$(defaults read com.apple.terminal 'Default Window Settings')";
if [ "${CURRENT_PROFILE}" != "${TERM_PROFILE}" ]; then
	open "${HOME}/monokai.terminal/${TERM_PROFILE}.terminal";
